      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        >
          <MagneticButton
            ...
            className="inline-flex items-center gap-2 bg-emerald-light hover:bg-emerald text-[#ffffff] font-semibold px-7 py-3.5 rounded-full transition-all duration-300 hover:shadow-lg text-sm"
          >
